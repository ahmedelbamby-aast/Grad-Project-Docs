...
- **SC-017**: Evidence artifacts are non-placeholder, immutable or digest-addressed where applicable, PostgreSQL-backed where relational state is involved, and reproducible from recorded lineage.
