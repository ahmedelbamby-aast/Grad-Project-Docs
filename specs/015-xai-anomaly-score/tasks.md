...
- [X] T330 [US6] Run the native RTX 5090 stride-1 baseline/candidate pair (after the GPU is free of training runs) and record parity/identity/lifecycle/FPS evidence
