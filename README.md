...
| 3d | [`.specify/memory/constitution.md`](.specify/memory/constitution.md) | 2026-06-03 (v2.6.0) | Full constitutional text. Section 8.1.1 governs concurrency scaling; Section 19 is the DSP backstop. Footer carries `**Version** \| **Ratified** \| **Last Amended**`. |
