...
| 3d | [`.specify/memory/constitution.md`](.specify/memory/constitution.md) | 2026-06-04 (v2.9.0) | Full constitutional text. Section 4.6 governs independent-run/sharded identity association; Section 8.1.1 governs concurrency scaling; Section 19 is the DSP backstop. Footer carries `**Version** \| **Ratified** \| **Last Amended**`. |
...
| 37t | [`docs/cycle_14a_pose_tail_decomposition_results.md`](docs/cycle_14a_pose_tail_decomposition_results.md) | 2026-06-03 | Cycle 14.A production measurement result: RTMPose runtime/provider dominates the remaining pose tail; no optimization decision. |
...
| 37va | [`docs/xai_anomaly/README.md`](docs/xai_anomaly/README.md) | 2026-06-10 | Feature-specific XAI/anomaly doc index for Cycle 015 score artifacts and current blocker status. |
| 37vaa | [`docs/xai_anomaly/cycle_015_0_investigation.md`](docs/xai_anomaly/cycle_015_0_investigation.md) | 2026-06-10 | Cycle 015.0 runtime-truth local investigation for route immutability, snapshot digests, and BSIL activation prerequisites. |
| 37vab | [`docs/xai_anomaly/cycle_015_0_figure_plan.md`](docs/xai_anomaly/cycle_015_0_figure_plan.md) | 2026-06-10 | Figure Planner output for Cycle 015.0 runtime-truth and BSIL activation evidence. |
| 37vac | [`docs/xai_anomaly/cycle_015_0_figure_implementation.md`](docs/xai_anomaly/cycle_015_0_figure_implementation.md) | 2026-06-10 | Figure Implementer ownership record for the Cycle 015.0 local route-snapshot slice. |
| 37vb | [`docs/xai_anomaly/cycle_015_5_investigation.md`](docs/xai_anomaly/cycle_015_5_investigation.md) | 2026-06-10 | Cycle 015.5 score-profile, no-ground-truth evaluation protocol, prohibited metrics, and current completion boundary. |
...
| 37vi | [`docs/xai_anomaly/cycle_015_6_results.md`](docs/xai_anomaly/cycle_015_6_results.md) | 2026-06-10 | Cycle 015.6 staged-local-only results: conformal tooling and validation are in place, but production benchmark, rollback proof, and ledger entry remain open. |
| 37vj | [`docs/xai_anomaly/cycle_015_7_investigation.md`](docs/xai_anomaly/cycle_015_7_investigation.md) | 2026-06-10 | Cycle 015.7 identity-gated fusion protocol and explanation-graph local implementation boundary. |
| 37vk | [`docs/xai_anomaly/cycle_015_7_figure_plan.md`](docs/xai_anomaly/cycle_015_7_figure_plan.md) | 2026-06-10 | Figure Planner output for Cycle 015.7 graph and contradiction evidence. |
| 37vl | [`docs/xai_anomaly/cycle_015_7_figure_implementation.md`](docs/xai_anomaly/cycle_015_7_figure_implementation.md) | 2026-06-10 | Figure Implementer ownership record for the Cycle 015.7 local slice. |
| 37vm | [`docs/xai_anomaly/cycle_015_7_results.md`](docs/xai_anomaly/cycle_015_7_results.md) | 2026-06-10 | Cycle 015.7 staged-local-only results: fusion helper tooling and validation are in place, but production benchmark, rollback proof, and ledger entry remain open. |
...
| 37vr | [`docs/xai_anomaly/security_retention_policy.md`](docs/xai_anomaly/security_retention_policy.md) | 2026-06-10 | Feature-owned privacy, access, audit, and retention policy for Cycle 015 score, explanation, and deep-XAI artifacts. |
| 37vs | [`docs/xai_anomaly/no_ground_truth_governance.md`](docs/xai_anomaly/no_ground_truth_governance.md) | 2026-06-10 | Setup-slice governance rules for reviewer feedback, prohibited metrics, and future trainable-model boundaries. |
| 37vt | [`docs/xai_anomaly/glossary.md`](docs/xai_anomaly/glossary.md) | 2026-06-10 | Required observed-pattern vocabulary and knowledge-limit terminology for Cycle 015 docs and payloads. |
| 37vu | [`docs/xai_anomaly/configuration_contract.md`](docs/xai_anomaly/configuration_contract.md) | 2026-06-10 | Ownership and fingerprint contract for all configured or learned Cycle 015 operational values. |
| 37vv | [`docs/xai_anomaly/figure_role_template.md`](docs/xai_anomaly/figure_role_template.md) | 2026-06-10 | Exactly-one Figure Planner / Figure Implementer kickoff template for future Cycle 015 runs. |
| 37vw | [`docs/xai_anomaly/cycle_result_template.md`](docs/xai_anomaly/cycle_result_template.md) | 2026-06-10 | Standard Cycle 015 results/decision template with production-evidence and rollback sections. |
| 37vx | [`docs/xai_anomaly/production_cycle_runbook.md`](docs/xai_anomaly/production_cycle_runbook.md) | 2026-06-10 | Template preflight, benchmark, figure, and rollback runbook for future production Cycle 015 runs. |
| 37vy | [`docs/xai_anomaly/setup_validation.md`](docs/xai_anomaly/setup_validation.md) | 2026-06-10 | Local documentation and source-reference validation record for the setup-slice artifacts. |
...
| 37aa1 | [`docs/cycle_14c3_batch32_parallel_chunks_investigation.md`](docs/cycle_14c3_batch32_parallel_chunks_investigation.md) | 2026-06-03 | Cycle 14.C3 investigation: batch-32-specific internal RTMPose chunk parallelism candidate before any acceptance decision. |
| 37aa2 | [`docs/cycle_14c3_batch32_parallel_chunks_results.md`](docs/cycle_14c3_batch32_parallel_chunks_results.md) | 2026-06-03 | Cycle 14.C3 production result: batch-32 chunk parallelism rejected because RTMPose latency and DB FPS regressed. |
| 37aa3 | [`docs/cycle_14d_server_side_compact_postproc_investigation.md`](docs/cycle_14d_server_side_compact_postproc_investigation.md) | 2026-06-03 | Cycle 14.D investigation: next sorted server-side compacting cycle split into sub-candidates before code. |
| 37aa4 | [`docs/cycle_14d_server_side_compact_postproc_results.md`](docs/cycle_14d_server_side_compact_postproc_results.md) | 2026-06-03 | Cycle 14.D Phase A result: no compact-output implementation selected because Python BLS is runtime-blocked and decode/output cost is small after Top-K. |
| 37aa5 | [`docs/cycle_15_cuda_shared_memory_vs_sharding_investigation.md`](docs/cycle_15_cuda_shared_memory_vs_sharding_investigation.md) | 2026-06-03 | Cycle 15 investigation: CUDA shared memory versus video sharding architecture decision before code. |
| 37aa6 | [`docs/cycle_15_cuda_shared_memory_vs_sharding_results.md`](docs/cycle_15_cuda_shared_memory_vs_sharding_results.md) | 2026-06-03 | Cycle 15 Phase A result: shared memory is not selected for immediate implementation; sharding moves to design-proof. |
...
| 37aa11 | [`docs/cycle_15b1_two_shard_runtime_investigation.md`](docs/cycle_15b1_two_shard_runtime_investigation.md) | 2026-06-03 | Cycle 15.B1 runtime investigation: two-shard parent/shard implementation contract before code. |
| 37aa12 | [`docs/cycle_17_redis_streams_progress_sampling_investigation.md`](docs/cycle_17_redis_streams_progress_sampling_investigation.md) | 2026-06-04 | Cycle 17 investigation: bounded Redis Streams for non-authoritative benchmark progress sampling after measured sharding candidates failed correctness. |
| 37aa12a | [`docs/agent_17_cycle_17_turn.md`](docs/agent_17_cycle_17_turn.md) | 2026-06-04 | Agent 17 turn record: states that this session has taken the Cycle 17 Redis Streams turn, lists responsibilities and boundaries, and defines the required `AGENTS.md` turn-claim/release protocol. |
| 37aa12b | [`docs/agent_18_cycle_17_turn.md`](docs/agent_18_cycle_17_turn.md) | 2026-06-04 | Agent 18 turn record: records the user-authorized Cycle 17 reassignment from Agent 17, Phase B responsibilities, benchmark-lock state, and handoff protocol. |
| 37aa12c | [`docs/agent_19_cycle_18_turn.md`](docs/agent_19_cycle_18_turn.md) | 2026-06-04 | Agent 19 turn record: maps Agent 19 to the Agent B Cycle 18 contract-only lane, claims the evidence-audit tasks, and defines non-overlap boundaries with Agents 17 and 18. |
| 37aa12d | [`docs/agent_20_remaining_lanes_turn.md`](docs/agent_20_remaining_lanes_turn.md) | 2026-06-04 | Agent 20 turn record: maps the final agent to the remaining Agent C and Agent D lanes, claiming Cycle 20 readiness and Cycle 21 concurrency governance without runtime or production changes. |
| 37aa12e | [`docs/agent_20_cycle_18_override_turn.md`](docs/agent_20_cycle_18_override_turn.md) | 2026-06-04 | Agent 20 Cycle 18 override ledger: records the user-authorized reassignment, rejected `one_to_one` candidate, boundary packet producer evidence run, rollback proof, and remaining identity-merge blocker. |
| 37aa13 | [`docs/cycle_18_redis_boundary_state_cache_investigation.md`](docs/cycle_18_redis_boundary_state_cache_investigation.md) | 2026-06-04 | Cycle 18 investigation: records the Agent 19 contract-only handoff, Agent 20 `one_to_one` production rejection, evidence-only boundary packet producer validation, and remaining merge-ready identity-state work. |
| 37aa14 | [`docs/cycle_18_identity_association_root_cause_investigation.md`](docs/cycle_18_identity_association_root_cause_investigation.md) | 2026-06-04 | Cycle 18 deep root-cause investigation: separates invalid raw local-ID comparison from measured residual association loss and defines the required tracklet-state proof. |
...
| 102a | [`docs/entity/systems/osnet_ain_x1_0_reid_model.md`](docs/entity/systems/osnet_ain_x1_0_reid_model.md) | 2026-06-05 | Offline-only OSNet-AIN x1.0 ReID Triton model staged for Cycle 18.D boundary appearance; production build, parity, and benchmark evidence still pending. |
...
| 124 | [`docs/entity/cycles/cycles_1_to_5_bundle.md`](docs/entity/cycles/cycles_1_to_5_bundle.md) | 2026-06-03 | DSP Cycle 4 (1/N) — first optimization-cycle entity doc. Folds the 5-change Cycles 1-5 bundle (telemetry-writer fix + concurrency knob + batch frames + malloc-trim + concat memo) into one canonical record citing job `74ec0432` (Step 2 FPS 2.09 → 5.14, overall FPS 1.31 → 2.08). Anchor baseline for every later cycle. |
| 125 | [`docs/entity/cycles/cycle_6_pose_chunking.md`](docs/entity/cycles/cycle_6_pose_chunking.md) | 2026-06-03 | DSP Cycle 4 (2/N) — pose-runtime `rtmpose_model` batch>16 fix. `PoseRuntime._provider_infer_batch` now chunks crops to `max_batch_size=16`; eliminates gRPC→HTTP fallback. Job `a1a448b9`: pose-upload 12m13s → 3m42s (−69.7 %), overall FPS 2.077 → 2.78 (+33.8 % over Cycles 1-5, +112 % over baseline `77650001`). |
| 126 | [`docs/entity/cycles/cycle_7_redis_client_cache.md`](docs/entity/cycles/cycle_7_redis_client_cache.md) | 2026-06-03 | DSP Cycle 4 (3/N) — cache Redis client across the embedding loop. `apps.tracking.embeddings.redis_client` + `apps.video_analysis.tasks._redis_client` now cache per-`REDIS_URL`. Job `515fe118`: embedding wall 467.6s → 450.7s (−3.6 %), total 1633s → 1582s (−3.1 %), overall FPS 2.78 → 2.87 (+3.2 %). ACCEPTED with hypothesis correction — projected +24 % FPS, real +3.2 %; falsification redirected attack to Cycle 8 (`cv2.VideoCapture.set` + bulk_create). |
| 127 | [`docs/entity/cycles/cycle_8_embedding_stage.md`](docs/entity/cycles/cycle_8_embedding_stage.md) | 2026-06-03 | DSP Cycle 4 (4/N) — 3-lever embedding-stage attack: `OFFLINE_EMBEDDING_REUSE_BY_TRACK=1` (72 k → 53 `model.embed()`), lazy `cv2_cap.grab()` for forward-skip, `persist_embeddings_bulk(batch_size=500)`. Job `d2de80a0`: embedding wall 450.7s → ~174s (−61.5 %), total 1582s → 1312s (−17.1 %), overall FPS 2.87 → 3.46 (+20.5 %, +164 % over baseline `77650001`). |
| 128 | [`docs/entity/cycles/cycle_9_behavior_ensemble.md`](docs/entity/cycles/cycle_9_behavior_ensemble.md) | 2026-06-03 | DSP Cycle 4 (5/N) — **NOT ACCEPTED**. `behavior_ensemble:v1` collapsed four app-side behavior gRPC calls into one. Job `c1651663`: tensor max-abs diff `0.0` (exact correctness parity), DB-completed FPS 3.46 → 4.09 (+18.1 %), but Step 2 wall +0.6 % (primary acceptance gate did not move). Seeded Cycle 9b B.2.a/B.2.b/B.2.c continuation. First entity doc recording a NOT-ACCEPTED outcome in the optimization log. |
| 129 | [`docs/entity/cycles/cycle_9b_b2b_exact_slice.md`](docs/entity/cycles/cycle_9b_b2b_exact_slice.md) | 2026-06-03 | DSP Cycle 4 (6/N) — Cycle 9b B.2.b **ACCEPTED**. Server-side TensorRT Gather slices `gaze_horizontal_model` output `[84,2100]` → `[6,2100]`; `behavior_ensemble_gaze_slice:v1` routes only horizontal-gaze through the slice. Job `7933c1e5`: Step 2 wall 858 s → 574 s (−33.1 %), Step 2 FPS 5.29 → 7.91 (+49.6 %), parity max abs diff `0.0` pre + post bench. Recovered after B.2.a `gaze2` standalone parity-fail rollback (preserved per § 19.5). |
| 130 | [`docs/entity/cycles/cycle_9b_b2c_topk.md`](docs/entity/cycles/cycle_9b_b2c_topk.md) | 2026-06-03 | DSP Cycle 4 (7/N) — Cycle 9b B.2.c **ACCEPTED WITH CAVEAT** — *current production accepted baseline*. Chains TensorRT Top-K adapters (posture / gaze-horizontal-slice / gaze-vertical / gaze-depth) after the dense behavior children; `behavior_ensemble_gaze_slice_topk:v1` is the active route. Job `be4ba9ee`: Step 2 wall 574 s → 540 s (−5.84 %), DB FPS 4.31 → 4.43 (+2.8 %), behavior output 6.85 → 0.33 MB/frame (~95 % less), decoded parity `failed_count=0`. Caveat: avg GPU util flat — next attacks must target GPU occupancy. FP16 Top-K plans failed parity → FP32 only. |
| 131 | [`docs/entity/cycles/cycle_10_lpm_phase1.md`](docs/entity/cycles/cycle_10_lpm_phase1.md) | 2026-06-03 | DSP Cycle 4 (8/N) — Cycle 10 LPM Phase 1 **NEEDS FURTHER ITERATION — NOT ACCEPTED**. Wired the pre-existing `logical_path_matrix.apply_to_detection_boxes` math layer into `_run_crop_behaviour_for_items()` + shipped `TelemetryLpmEvent` (models.py:230) + migration `0002`. Two prod benches failed: job `17075418` dropped `attention_tracking` boxes 11776 → 2680; safety-fix bench `21666815` restored to 11122 but produced `C1=0` `eliminated=0` — zero contradiction signal. Permanent prod state: `LPM_ENABLED=0`. Lesson: next LPM design must capture pre-decode gaze probabilities or run inside the future BLS path. |
| 132 | [`docs/thesis_audit/README.md`](docs/thesis_audit/README.md) | 2026-06-04 | Thesis chapter audit — index. Cross-document consistency matrix + severity rollup + recommended-fix helpers for the 4 audited chapter PDFs. PDF mirror: `audit_report.pdf` regenerated by `scripts/build_audit_pdf.py`. |
| 133 | [`docs/thesis_audit/chapter_1_introduction.md`](docs/thesis_audit/chapter_1_introduction.md) | 2026-06-04 | Chapter 1 audit. **HIGH** severity. "Ten classes" framing contradicted by `backend/config/settings/base.py:280-284` (5 deployed binary classifiers); YOLO architecture list overstates what's wired (only YOLOv8-style decode at `tasks.py:1571`). Missing: Triton, BSIL, streaming bridge. |
| 134 | [`docs/thesis_audit/chapter_2_literature_review.md`](docs/thesis_audit/chapter_2_literature_review.md) | 2026-06-04 | Chapter 2 audit. **MEDIUM** severity. "Eight classes" internally inconsistent with Ch 1's "ten"; reference-list typos (`SCP-Dataset`→`SCB-Dataset`, `the Student`→`Students`, missing Sumaiya author attribution, `Examination`→`Examinations`). |
| 135 | [`docs/thesis_audit/chapter_5_simulation_evaluation.md`](docs/thesis_audit/chapter_5_simulation_evaluation.md) | 2026-06-04 | Chapter 5 audit. **LOW–MEDIUM** wrong claims (YOLO26 misclassified as a behavior model; EDUNET dataset untraceable in repo), **HIGH** missing (Triton ensemble + Top-K + slice adapters absent despite being the deployed inference path). |
| 136 | [`docs/thesis_audit/chapter_7_business_model.md`](docs/thesis_audit/chapter_7_business_model.md) | 2026-06-04 | Chapter 7 audit. **HIGH** severity. Fabricated product name "Sentinel AI"; falsely claims facial recognition, audio monitoring, Moodle/Open edX integration, edge-compute hardware. Missing: BSIL, anomaly review, Triton, RTSP/WHEP bridge. |
| 137 | [`docs/four_agent_cycle_coordination_board.md`](docs/four_agent_cycle_coordination_board.md) | 2026-06-04 | Four-agent execution board for current optimization cycles. Divides Cycle 17, Cycle 18, Cycle 20, and Cycle 21 ownership; defines production benchmark lock, shared-file ownership, and decision gates after Cycle 15 sharding candidates were not accepted. |
...
| `CELERY_DEFAULT_WORKER_CONCURRENCY` | `2` in `tools/prod/prod_start_celery_workers.sh` | `tools/prod/prod_start_celery_workers.sh`, `tools/prod/prod_enable_parallel_flow.sh` | Production default queue worker concurrency. | Positive integer. | Do not raise as an optimization without Cycle 21-style production benchmark evidence; extra workers can be idle or increase contention. |
| `CELERY_LIVE_WORKER_CONCURRENCY` | `2` in `tools/prod/prod_start_celery_workers.sh` | `tools/prod/prod_start_celery_workers.sh` | Production live-mode per-stage worker concurrency. | Positive integer. | Must be tuned separately from offline queues and only under the active live profile. |
| `CELERY_OFFLINE_WORKER_CONCURRENCY` | `4` in optimized production helper | `tools/prod/prod_start_celery_workers.sh`, `tools/prod/prod_enable_parallel_flow.sh` | Production offline-mode control/person/pose/behavior worker concurrency. | Positive integer. | Raising it helps only if there is parallel work for extra workers; for one monolithic offline job it is hypothesis-only until benchmarked. |
| `CELERY_GPU_CONCURRENCY_CAP` | `0` in optimized production helper | `tools/prod/prod_start_celery_workers.sh`, `tools/prod/prod_enable_parallel_flow.sh` | Optional cap applied to per-worker concurrency before launching active profile workers. | `0` for no cap, or positive integer. | Use to prevent GPU-bound queue contention; changing it requires topology proof and production benchmark evidence. |
...
| Variable | Example / Default | Used by | Why it exists | Acceptable values | Role / operational effect |
| --- | --- | --- | --- | --- | --- |
| `BENCHMARK_REDIS_STREAM_EVENTS` | `0` | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_run_cycle17_redis_streams_benchmark.sh` | Cycle 17 candidate flag for mirroring lightweight benchmark progress into Redis Streams. | Boolean-like values. Default must remain `0` outside the Cycle 17 benchmark wrapper. | When enabled, writes capped non-authoritative progress events; PostgreSQL remains terminal authority. |
| `BENCHMARK_REDIS_STREAM_MAXLEN` | `1000` | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_watch_benchmark_metrics.sh` | Bounds Redis Stream event retention for Cycle 17. | Integer `10` to `1000000`. | Prevents unbounded Redis growth; larger values preserve more watcher history. |
| `BENCHMARK_REDIS_STREAM_TTL_SECONDS` | `86400` | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_collect_benchmark_metrics.py` | Sets expiry for Cycle 17 benchmark progress streams. | Integer `60` to `2592000`. | Ensures benchmark stream keys are disposable and do not become persistent authority. |
| `WATCH_REDIS_STREAM_EVENTS` | `0` | `tools/prod/prod_watch_benchmark_metrics.sh` | Enables the read-only watcher table for Cycle 17 Redis Stream evidence. | Boolean-like values or use `--redis-stream`. | Shows stream length, TTL, latest event, and errors while still polling PostgreSQL for authority. |
| `WATCH_DB_FULL_POLL_EVERY_N` | `1` | `tools/prod/prod_watch_benchmark_metrics.sh` | Declares the watcher DB full-poll interval for Cycle 17 stream-mode experiments. | Positive integer. | Evidence knob for DB-polling experiments; PostgreSQL remains the source of truth. |
...
| `TRITON_CROP_FRAME_BEHAVIOR_OVERLAP` | `0` in base defaults, `1` in optimized production helper | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_run_behavior_overlap_benchmark.sh` | Enables the accepted Cycle 12.C single-in-flight crop-frame behavior overlap. | Boolean-like values. Production uses `1`; rollback is `0` plus Celery worker restart. | Overlaps previous behavior execution with current person/crop preparation while preventing two behavior jobs in flight. Accepted benchmark `cycle12-single-inflight-overlap-20260602T225821Z` improved Step 2 wall and FPS without material RTT regression. |
| `OFFLINE_VIDEO_SHARDING_ENABLED` | `0` | `backend/config/settings/base.py`, `tools/prod/prod_enable_parallel_flow.sh` | Disabled-by-default Cycle 15.B1 gate for offline two-shard runtime experiments. | Boolean-like values. Must stay `0` for live profiles and until the sharded runtime has parent/shard merge, idempotency, rollback, and production benchmark proof. | Prevents planned offline-only sharding work from being enabled accidentally. Setting it to `1` before runtime support exists is invalid. |
| `OFFLINE_VIDEO_SHARD_COUNT` | `1` | `backend/config/settings/base.py`, `tools/prod/prod_enable_parallel_flow.sh` | Planned shard count knob for governed offline video sharding. | Integer `1..16`; current accepted profile is `1`. | Reserved for Cycle 15.B1+ runtime implementation. It has no behavior effect until `OFFLINE_VIDEO_SHARDING_ENABLED=1` and runtime support are implemented. |
| `OFFLINE_VIDEO_SHARD_CONTEXT_FRAMES` | `32` | `backend/config/settings/base.py`, `tools/prod/prod_enable_parallel_flow.sh`, `tools/prod/prod_plan_video_shards.py` | Planned pre-roll context frame count for non-first shards. | Integer `0..300`; design proof used `32`. | Context frames may warm tracking but must never persist authoritative DB rows. This remains offline-only and blocked for live streams. |
| `OFFLINE_VIDEO_SHARD_TRACK_MAP_MODE` | `best_iou` | `backend/config/settings/base.py`, `backend/apps/video_analysis/services/offline_sharding.py`, `tools/prod/prod_run_cycle15b1_two_shard_runtime_benchmark.sh` | Selects the parent-side child-track canonicalization algorithm for offline sharded merge candidates. | `best_iou` or `majority_vote`. Production default is `best_iou`; `majority_vote` is Cycle 15.B1.C2 candidate-only. | This is offline-only and must stay disabled for live profile sharding. Changing it requires a full production `combined.mp4` benchmark and model-agreement gate. |
| `OFFLINE_VIDEO_SHARD_TRACK_MAP_IOU_THRESHOLD` | `0.50` | `backend/config/settings/base.py`, `backend/apps/video_analysis/services/offline_sharding.py` | Minimum IoU for a boundary box match to vote for parent/child track canonicalization. | Float from `0.0` to `1.0`. | Raising it reduces false merges but can leave shard-local offset IDs; lowering it risks wrong identity stitching. |
| `OFFLINE_VIDEO_SHARD_TRACK_MAP_MIN_MATCHES` | `3` | `backend/config/settings/base.py`, `backend/apps/video_analysis/services/offline_sharding.py` | Minimum accepted boundary votes for `majority_vote` track-map mode. | Integer `1..300`. | Guards against one-frame false matches during shard merge. |
| `OFFLINE_VIDEO_SHARD_TRACK_MAP_PURITY_THRESHOLD` | `0.85` | `backend/config/settings/base.py`, `backend/apps/video_analysis/services/offline_sharding.py` | Minimum vote purity for `majority_vote` track-map mode. | Float from `0.0` to `1.0`. | Keeps ambiguous child tracks on offset IDs instead of merging them into a parent identity. |
| `POSE_TAIL_PROFILING` | `0` | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `backend/apps/pipeline/services/pose_runtime.py`, `tools/prod/prod_run_cycle14a_pose_tail_profile_benchmark.sh` | Enables Cycle 14.A measurement-only decomposition of the Step 2 pose tail. | Boolean-like values. Enable only during the governed Cycle 14.A production benchmark; rollback is `0` plus Celery worker restart. | Records pose frame-read, box-selection, payload-build, runtime, provider, decode, record-build, enrichment, artifact-write, metadata-save, and drain timing in the inference audit. It does not accept an optimization by itself. |
| `POSE_TAIL_OPTIMIZATION_MODE` | `off` in base defaults, `cross_frame_batch` in optimized production | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_run_cycle14b_pose_tail_scenario_benchmark.sh` | Selects the guarded Cycle 14.B RTMPose tail scenario. | `off`, `overlap`, or `cross_frame_batch`. | `overlap` was not accepted; fixed `cross_frame_batch` is accepted from replay `cycle14b-cross-frame-batch16-r2-20260603T150000Z`. Rollback is `off` plus Celery restart. |
| `POSE_CROSS_FRAME_BATCH_SIZE` | `16` | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_run_cycle14b_pose_tail_scenario_benchmark.sh` | Caps the Cycle 14.B2 ordered cross-frame RTMPose crop batch. | Positive integer; production default uses the RTMPose engine cap. | Changing this requires a full production benchmark because too-large batches can violate Triton engine limits or change latency. |
| `POSE_PROVIDER_CHUNK_PARALLELISM` | `1` | `backend/config/settings/base.py`, `backend/apps/pipeline/services/pose_runtime.py`, `tools/prod/prod_run_cycle14c3_batch32_parallel_chunks_benchmark.sh` | Controls Cycle 14.C3 internal RTMPose provider chunk parallelism after cross-frame batches exceed the engine cap. | Positive integer; accepted production default remains `1`. | Candidate value `2` is only valid inside the governed batch-32 benchmark. It must be restored to `1` unless production metrics explicitly accept it. |
| `EMBEDDING_STAGE_PROFILING` | `0` | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_run_cycle13_embedding_profile_benchmark.sh`, `tools/prod/prod_run_cycle13_track_lookup_benchmark.sh`, `tools/prod/prod_run_cycle13c_redis_command_profile_benchmark.sh` | Records embedding-stage sub-step timing into `job.metadata.embedding_summary.profile`. | Boolean-like values. Enable only during production benchmark probes; rollback is `0` plus Celery worker restart. | Measurement-only flag from Cycle 13.A. It must not be used as acceptance evidence without a completed `combined.mp4` production benchmark. |
| `EMBEDDING_PREFETCH_TRACK_LOOKUP` | `0` in base defaults, `1` in optimized production helper | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_enable_parallel_flow.sh`, `tools/prod/prod_run_cycle13_track_lookup_benchmark.sh` | Enables the accepted Cycle 13.B path that resolves embedding `StudentTrack` values from prefetched bounding boxes instead of per-detection ORM lookups. | Boolean-like values. Production uses `1`; rollback is `0` plus Celery worker restart. | Accepted benchmark `cycle13-track-lookup-20260603T011324Z` reduced embedding track lookup `66.223 s -> 0.447 s`, improved DB FPS, and preserved DB/model parity. |
| `OFFLINE_REDIS_COMMAND_PROFILING` | `0` | `backend/config/settings/base.py`, `backend/apps/video_analysis/tasks.py`, `tools/prod/prod_run_cycle13c_redis_command_profile_benchmark.sh` | Enables Cycle 13.C / 16.A measurement-only Redis command-cost profiling during the embedding side-effect flush. | Boolean-like values. Enable only with `EMBEDDING_STAGE_PROFILING=1` during a production benchmark; rollback is `0` plus Celery worker restart. | Records estimated helper command counts, Redis `INFO commandstats` deltas, payload bytes, Redis memory delta, helper wall, and profiling overhead. It does not change Redis semantics and cannot accept an optimization by itself. |
