...
| 3d | [`.specify/memory/constitution.md`](.specify/memory/constitution.md) | 2026-06-03 (v2.8.0) | Full constitutional text. Section 8.1.1 governs concurrency scaling; Section 19 is the DSP backstop. Footer carries `**Version** \| **Ratified** \| **Last Amended**`. |
...
| 37aa13 | [`docs/cycle_18_redis_boundary_state_cache_investigation.md`](docs/cycle_18_redis_boundary_state_cache_investigation.md) | 2026-06-04 | Cycle 18 investigation: Redis boundary-state cache remains Phase A contract-only; runtime implementation is blocked until a new identity-state design proof addresses the failed Cycle 15 sharding results. |
