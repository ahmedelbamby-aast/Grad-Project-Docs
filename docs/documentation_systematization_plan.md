...
| **3** | Module-level entity docs (Django apps + frontend packages) | **IN PROGRESS** (1 of ~18 landed: `apps.video_analysis`) | One doc per module in `docs/entity/modules/`; covers internal call graph, cross-module deps, DB tables, env vars, public APIs |
