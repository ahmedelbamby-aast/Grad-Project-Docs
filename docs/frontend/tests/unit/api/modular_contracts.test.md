# frontend/tests/unit/api/modular_contracts.test.ts

## Related Documents

- [source](../../../../../frontend/tests/unit/api/modular_contracts.test.ts)
...
This module sits at `frontend/tests/unit/api/modular_contracts.test.ts` and acts as a concrete implementation boundary inside the repository. Transport adapter that turns frontend intent into concrete backend REST calls and normalized responses.
