# frontend/tests/e2e/camera-feed.spec.ts

## Related Documents

- [source](../../../../frontend/tests/e2e/camera-feed.spec.ts)
...
This module sits at `frontend/tests/e2e/camera-feed.spec.ts` and acts as a concrete implementation boundary inside the repository. Verification layer that asserts runtime behavior, contracts, and regressions for the adjacent implementation.
