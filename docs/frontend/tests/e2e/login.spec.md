...
- [source](../../../../frontend/tests/e2e/login.spec.ts)
...
This module sits at `frontend/tests/e2e/login.spec.ts` and acts as a concrete implementation boundary inside the repository. Verification layer that asserts runtime behavior, contracts, and regressions for the adjacent implementation.
