...
- [source](../../../../frontend/tests/integration/theme.test.tsx)
...
This module sits at `frontend/tests/integration/theme.test.tsx` and acts as a concrete implementation boundary inside the repository. Verification layer that asserts runtime behavior, contracts, and regressions for the adjacent implementation.
