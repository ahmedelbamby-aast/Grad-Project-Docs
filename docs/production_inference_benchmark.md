...
| 2026-05-31 21:47 EEST | `parallel-per-frame-signals-crop-frame-20260531T214740` | `e8071c5a-8fb7-4c23-882d-621f8469c097` | Active run on commit `ae8a8b06` with `TRITON_NUMPY_OUTPUTS=True`. First probe: `25/4541`, `window_fps=0.400`; active worker RSS around 12 GiB, confirming the >100 GiB Python-list output spike is fixed. |
