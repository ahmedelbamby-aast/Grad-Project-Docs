...
| 2026-05-31 23:07 EEST | `parallel-per-frame-signals-nms100-crop-frame-20260531T230706` | `80027072-a9d4-4be7-9099-4354acd1170b` | Active validation of `TRITON_YOLO_MAX_DECODE_CANDIDATES=100`. Probe at `125/4541`: 90-second window throughput `1.111 fps`, overall `0.925 fps`, worker RSS ~1.7 GiB, per-frame-signal contract active. |
