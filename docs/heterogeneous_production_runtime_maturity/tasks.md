...
- [ ] T002 [P] Add a production evidence directory convention for this plan in `ci_evidence/production/runtime_maturity/README.md`
- [ ] T003 [P] Add a short operator checklist for this plan in `docs/production/runtime_maturity_operator_checklist.md`
- [ ] T004 Update production helper documentation to name `release/prod-runtime-stabilization` as the target stabilization branch in `docs/heterogeneous_production_runtime_maturity_plan.md`
- [ ] T005 [P] Add the local contract workflow for this plan in `.github/workflows/prod-runtime-maturity.yml`
- [ ] T006 [P] Add a production evidence orchestrator in `tools/prod/prod-runtime-maturity-evidence.ps1`
- [ ] T007 [P] Add evidence templates in `ci_evidence/production/runtime_maturity/acceptance_matrix.md` and `ci_evidence/production/runtime_maturity/manifest.template.json`

## Phase 2: Foundational

- [ ] T008 Audit current runtime mode, inference strategy, env loading, replay, Celery routing, and production helper scripts; record findings in `ci_evidence/production/runtime_maturity/local_code_audit.md`
- [ ] T009 Map existing tests that cover env contracts, runtime mode authority, endpoint isolation, replay, queue routing, and causality export in `ci_evidence/production/runtime_maturity/test_coverage_map.md`
...
- [ ] T020 [US2] Implement or harden production runtime preflight checks in `tools/prod/prod-runtime-preflight.sh`
...
- [ ] T028 [US2] Run focused local tests for env, strategy, runtime mode, and queue policy and save output to `ci_evidence/production/runtime_maturity/phase2_local_tests.md`
...
- [ ] T037 [US3] Run local replay policy tests and save output to `ci_evidence/production/runtime_maturity/phase3_replay_tests.md`
...
- [ ] T039 [US4] Add job-scoped GPU telemetry capture to `tools/prod/prod-health-snapshot.ps1`
- [ ] T040 [US4] Add Triton active/inactive endpoint evidence capture to `tools/prod/prod_triton_endpoint_policy.sh`
- [x] T041 [US4] Add model artifact hash collection to `tools/prod/write-evidence-manifest.py`
- [ ] T042 [US4] Add queue topology and Celery worker state collection to `tools/prod/prod-workers.ps1`
- [ ] T043 [US4] Ensure causality export accepts and records the exact job ID in `tools/benchmarks/export_benchmark_causality.py`
...
- [ ] T045 [P] [US4] Add causality job-ID integrity tests in `backend/tests/unit/scripts/test_benchmark_causality_job_integrity.py`
...
- [ ] T049 [US5] Add final evidence package validation to `tools/prod/write-evidence-manifest.py`
- [ ] T050 [P] [US5] Document final acceptance gates in `docs/production/runtime_maturity_operator_checklist.md`
...
- [ ] T059 Run the local focused backend suite for runtime authority, replay, queue policy, and causality and save output to `ci_evidence/production/runtime_maturity/final/local_test_summary.md`
