...
| **Cycle 15.B1/B2** | Two-shard and four-shard design proof | **READ-ONLY HELPER STAGED** | `prod_plan_video_shards.py` proves deterministic authoritative frame ownership and pre-roll context only; no runtime benchmark or acceptance decision exists. | `docs/cycle_15b1_two_shard_design_proof_investigation.md`, `docs/cycle_15b2_four_shard_design_proof_investigation.md` |
| **Cycle 15.B design proof** | Production dry-run comparison | **DESIGN PROOF PASSED / RUNTIME BLOCKED** | 15.B1 and 15.B2 have exact authoritative coverage; 15.B1 is the only eligible next runtime plan due lower overhead. No FPS/latency/GPU claim exists until sharded runtime benchmark. | `docs/cycle_15b_shard_design_probe_results.md` |
