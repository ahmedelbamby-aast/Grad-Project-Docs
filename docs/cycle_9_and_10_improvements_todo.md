...
| **Cycle 14.D** | Server-side compact postprocessing / BLS / TRT plugin if it reduces wait or server execution | **PHASE A STARTED** | Split into D1 Python BLS feasibility, D2 TensorRT-only compact postprocessing/plugin, and D3 fused behavior output contract before code. | `docs/cycle_14d_server_side_compact_postproc_investigation.md` |
