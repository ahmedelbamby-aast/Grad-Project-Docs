...
| **Cycle 15** | CUDA shared memory or sharding architecture decision | **PHASE A STARTED** | Split into 15.A CUDA shared memory and 15.B video sharding before code. | `docs/cycle_15_cuda_shared_memory_vs_sharding_investigation.md` |
