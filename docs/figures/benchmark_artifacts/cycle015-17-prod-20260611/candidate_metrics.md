...
- Replay key: `cycle015-17-prod-20260611-candidate`
- Job ID: `349010db-51c9-4b1a-8806-4a22a8afc541`
- Status: `completed`
...
| DB completed elapsed | `2869.358 s` |
| DB completed FPS | `1.583` |
| Step 2 frame wall | `1643.034 s` |
| Step 2 through pose upload | `2523.404 s` |
...
| Embedding created span | `163.426 s` |
...
| `job_db_completed` | `4541` | `2869.358000` | `1.582584` | `frames/s` | VideoAnalysisJob.processed_frames / (completed_at - created_at) | `` |
...
| `step2_frame_inference_loop` | `4541` | `1643.033552` | `2.763790` | `frames/s` | step2.triton_shadow.start -> step2.frame_stage_timings | `` |
| `step2_through_pose_tail` | `4541` | `2523.404417` | `1.799553` | `frames/s` | step2.triton_shadow.start -> step2.pose_upload | `` |
| `step2_pose_tail_only` | `4541` | `880.370865` | `5.158053` | `frames/s` | step2.frame_stage_timings -> step2.pose_upload | `` |
| `step2_stage_decode_s` | `4541` | `0.067285` | `67489.039162` | `frames/s` | summed Step 2 per-frame stage timing | `` |
| `step2_stage_inference_s` | `4541` | `2205.410692` | `2.059027` | `frames/s` | summed Step 2 per-frame stage timing | `` |
| `step2_stage_postprocess_s` | `4541` | `5013.709760` | `0.905717` | `frames/s` | summed Step 2 per-frame stage timing | `` |
| `step2_stage_preprocess_s` | `4541` | `103.293348` | `43.962173` | `frames/s` | summed Step 2 per-frame stage timing | `` |
| `step3_persistence` | `4541` | `151.995054` | `29.875972` | `frames/s` | step3.persistence.start -> step3.persistence.complete | `` |
...
| `step4_render` | `4541` | `27.668474` | `164.121809` | `frames/s` | step4.render.start -> step4.render.complete | `` |
| `post_render_finalize` | `4541` | `0.040387` | `112437.170377` | `frames/s` | step4.render.complete -> run.complete | `` |
| `telemetry_model_calls` | `13610` | `2869.358000` | `4.743221` | `calls/s` | TelemetryModelCall count over DB completed elapsed | `` |
| `db_frame_rows` | `4541` | `2869.358000` | `1.582584` | `rows/s` | db_frame_rows count over DB completed elapsed | `` |
| `db_detection_rows` | `127117` | `2869.358000` | `44.301548` | `rows/s` | db_detection_rows count over DB completed elapsed | `` |
| `db_bbox_rows` | `127117` | `2869.358000` | `44.301548` | `rows/s` | db_bbox_rows count over DB completed elapsed | `` |
| `db_embedding_rows` | `126519` | `2869.358000` | `44.093139` | `rows/s` | db_embedding_rows count over DB completed elapsed | `` |
| `db_pose_kinematics_rows` | `72931` | `2869.358000` | `25.417184` | `rows/s` | db_pose_kinematics_rows count over DB completed elapsed | `` |
| `boxes_person_detector` | `0` | `2869.358000` | `` | `boxes/s` | BoundingBox rows for person_detector over DB completed elapsed | `no_bbox_rows` |
| `boxes_posture_model` | `0` | `2869.358000` | `` | `boxes/s` | BoundingBox rows for posture_model over DB completed elapsed | `no_bbox_rows` |
| `boxes_horizontal_gaze_model` | `0` | `2869.358000` | `` | `boxes/s` | BoundingBox rows for horizontal_gaze_model over DB completed elapsed | `no_bbox_rows` |
| `boxes_vertical_gaze_model` | `0` | `2869.358000` | `` | `boxes/s` | BoundingBox rows for vertical_gaze_model over DB completed elapsed | `no_bbox_rows` |
| `boxes_depth_gaze_model` | `0` | `2869.358000` | `` | `boxes/s` | BoundingBox rows for depth_gaze_model over DB completed elapsed | `no_bbox_rows` |
...
|---|---:|---:|---:|---:|
| `decode_s` | `0.067285` | `0.001` | `67489.039162` | `0.014817` |
| `inference_s` | `2205.410692` | `30.118` | `2.059027` | `485.666305` |
| `postprocess_s` | `5013.709760` | `68.470` | `0.905717` | `1104.098163` |
| `preprocess_s` | `103.293348` | `1.411` | `43.962173` | `22.746828` |
| `stage_timing_sum` | `7322.481085` | `100.000` | `0.620145` | `1612.526114` |

## Per-Model Telemetry

| Model | Count | Calls/s | Mean ms | P50 ms | P95 ms | P99 ms | Max ms | Status | Shape |
|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| `behavior_ensemble` | `3597` | `1.253590` | `117.966` | `166.549` | `189.408` | `198.024` | `208.423` | `ok:3597` | `[32, 3, 320, 320]` |
| `gaze_horizontal_model` | `1` | `0.000349` | `30.032` | `30.032` | `30.032` | `30.032` | `30.032` | `ok:1` | `[1, 3, 320, 320]` |
| `gaze_vertical_model` | `1` | `0.000349` | `29.258` | `29.258` | `29.258` | `29.258` | `29.258` | `ok:1` | `[1, 3, 320, 320]` |
| `person_detector` | `910` | `0.317144` | `16.595` | `13.667` | `43.579` | `51.498` | `57.507` | `ok:910` | `[1, 3, 640, 640]` |
| `posture_model` | `1` | `0.000349` | `30.986` | `30.986` | `30.986` | `30.986` | `30.986` | `ok:1` | `[1, 3, 320, 320]` |
| `rtmpose_model` | `4559` | `1.588857` | `43.059` | `42.811` | `47.231` | `73.763` | `89.295` | `ok:4559` | `[16, 3, 256, 192]` |
| `yoloe_scene_seg` | `4541` | `1.582584` | `25.867` | `21.180` | `46.475` | `65.377` | `88.780` | `ok:4541` | `[1, 3, 640, 640]` |
...
| `person_detector` | `bbox` | `0` | `0.000` | `0.000` | `0.000000` | `0.000` | `0.000000` | `910` | `16.595` | `43.579` | `no_bbox_rows` |
| `posture_model` | `bbox` | `0` | `0.000` | `0.000` | `0.000000` | `0.000` | `0.000000` | `1` | `30.986` | `30.986` | `no_bbox_rows` |
| `rtmpose_model` | `keypoints` | `0` | `0.000` | `0.000` | `0.000000` | `0.000` | `0.000000` | `4559` | `43.059` | `47.231` | `output_kind_is_keypoints` |
| `vertical_gaze_model` | `bbox` | `0` | `0.000` | `0.000` | `0.000000` | `` | `` | `0` | `0.000` | `0.000` | `no_bbox_rows` |
| `yoloe_scene_seg` | `segmentation` | `0` | `0.000` | `0.000` | `0.000000` | `0.000` | `0.000000` | `4541` | `25.867` | `46.475` | `output_kind_is_segmentation` |
...
|---|---:|
| Enabled | `False` |
| Stream key | `bench:cycle015-17-prod-20260611-candidate:events` |
...
| DB completed FPS | `1.663871` | `1.582584` | `-4.89%` |
| DB completed elapsed s | `2729.178` | `2869.358` | `+5.14%` |
| Step 2 frame wall s | `1607.723744` | `1643.033552` | `+2.20%` |
| Step 2 through pose upload s | `2501.534326` | `2523.404417` | `+0.87%` |
...
| GPU avg util % | `4.672` | `4.357` | `-6.74%` |
| GPU peak util % | `49.0` | `49.0` | `+0.00%` |
| GPU peak mem MiB | `32099.0` | `16137.0` | `-49.73%` |
| Worker peak RSS MiB | `0.0` | `0.0` | `n/a` |
| Embedding created span s | `164.401` | `163.426` | `-0.59%` |
