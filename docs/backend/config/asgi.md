...
flowchart TB
    ...
    subgraph Dependencies["Project Dependencies"]
        I1["apps.anomalies.routing\nProject Module"]
        I2["apps.cameras.routing\nProject Module"]
        I3["apps.detections.routing\nProject Module"]
        I4["apps.health.routing\nProject Module"]
        I5["apps.video_analysis.routing\nProject Module"]
        I6["apps.sessions.routing\nProject Module"]
    end
...
This module sits at `backend/config/asgi.py` and acts as a concrete implementation boundary inside the repository. Python implementation module that contributes behavior to the repository runtime.

From a dependency perspective, the file currently reaches into `apps.anomalies.routing`, `apps.cameras.routing`, `apps.detections.routing`, `apps.health.routing`, `apps.video_analysis.routing`, `apps.sessions.routing`. Those links were read from the real source file so the diagram reflects the actual local coupling rather than an inferred architecture.
