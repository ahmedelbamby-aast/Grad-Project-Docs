# backend/apps/pipeline/openvino_compat.py

## Related Documents

- [source](../../../../backend/apps/pipeline/openvino_compat.py)
- [system atlas](../../../diagrams/SYSTEM_MERMAID_ATLAS.md)
- [source mirror](../../../diagrams/SOURCE_FILE_MIRROR.md)

## Executive View

OpenVINO compatibility shim for Ultralytics imports.
...
flowchart TB
    subgraph Source["Current Module"]
        SRC["backend/apps/pipeline/openvino_compat.py\nOpenVINO compatibility shim for Ultralytics imports."]
    end
...
This module sits at `backend/apps/pipeline/openvino_compat.py` and acts as a concrete implementation boundary inside the repository. Python implementation module that contributes behavior to the repository runtime.
