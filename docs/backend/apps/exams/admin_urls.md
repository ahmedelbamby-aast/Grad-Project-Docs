# backend/apps/exams/admin_urls.py

## Related Documents

- [source](../../../../backend/apps/exams/admin_urls.py)
- [system atlas](../../../diagrams/SYSTEM_MERMAID_ATLAS.md)
- [source mirror](../../../diagrams/SOURCE_FILE_MIRROR.md)

## Executive View

Admin exam & room management — mounted at /api/v1/admin/.
...
flowchart TB
    subgraph Source["Current Module"]
        SRC["backend/apps/exams/admin_urls.py\nAdmin exam & room management — mounted at /api/v1/admin/."]
    end
...
This module sits at `backend/apps/exams/admin_urls.py` and acts as a concrete implementation boundary inside the repository. Routing boundary that exposes concrete URL patterns for the surrounding application surface.

From a dependency perspective, the file currently reaches into `apps.exams.views`, `core.routers`. Those links were read from the real source file so the diagram reflects the actual local coupling rather than an inferred architecture.
