...
| `GAZE_HORIZONTAL_HEAD_VARIANT` | `coco80` | `apps.video_analysis.tasks._yolo_output_channels_for_task`, `tools/prod/prod_start_triton.sh`, `tools/prod/prod_enable_gaze_horizontal_slice.sh` (`gaze2` rejected, `slice` candidate) |
